...
def get_args():
    ...
    parser.add_argument("--vit-model", type=str, default="files/onnx/SAM-image-VITb.onnx", help="vit model path.")
    parser.add_argument("--decoder-model", type=str, default="files/onnx/SAM-VITb.onnx", help="decoder model path.")
    parser.add_argument("--device", type=str, default="cuda", help="The device to run generation on.")
    parser.add_argument("--warmup", type=int, default=3, help="Warmup epoch. if set 0, model won`t warmup.")
